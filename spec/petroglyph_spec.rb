...
describe Petroglyph do
  ...
  xit "adds a node with a simple value" do
  ...
  xit "nests stuff arbitrarily deeply" do
    t = Petroglyph::Template.build do
      node :drink do
        node :tea do
          node :temperature do
  ...
  xit "can handle helper methods" do
    def temperature
      "hot"
    end
